    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 dark:bg-gray-950">
        <div className="w-full max-w-md text-center">
          ...
          <a href="/login" className="mt-6 inline-block font-medium text-blue-600 hover:underline">
            Back to sign in
          </a>
        </div>
      </div>
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 dark:bg-gray-950">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-gray-500 dark:text-gray-400">Free forever · 3 scans/month · No credit card</p>
        </div>
        ...
        <Card>
          ...
          <form onSubmit={handleSignup} className="space-y-4" noValidate>
            ...
            <Button type="submit" color="blue" className="w-full font-semibold" isProcessing={loading} disabled={loading}>
              Create account
            </Button>
          </form>
          ...
          <Button color="light" className="w-full font-medium" onClick={handleGoogleLogin} type="button">
